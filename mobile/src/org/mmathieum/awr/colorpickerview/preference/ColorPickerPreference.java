package org.mmathieum.awr.colorpickerview.preference;
...
public class ColorPickerPreference extends DialogPreference implements ColorPickerView.OnColorChangedListener{
	...
	private void init(AttributeSet attrs) {
		...
		if(showPreviewSelectedColorInList) {
			setWidgetLayoutResource(R.layout.colorpickerview_preference);
		}
		...
		setDialogLayoutResource(R.layout.colorpickerview_dialog);
